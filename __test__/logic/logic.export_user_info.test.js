...
var export_user_info_1 = require("../../logic/export_user_info");
test("test for get non-escaped characters", function () {
    var export_user_info = new export_user_info_1.ExportUserInfo();
