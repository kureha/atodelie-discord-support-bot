module.exports = class Constants {
    constructor () {
        ...
        this.DISCORD_MESSAGE_TITLE_SUCCESS_VIEW = process.env.DISCORD_MESSAGE_TITLE_SUCCESS_VIEW;
        this.DISCORD_MESSAGE_SUCCESS_VIEW = process.env.DISCORD_MESSAGE_SUCCESS_VIEW;
        ...
        this.DISCORD_MESSAGE_EMBED_JOIN_MEMBERS = process.env.DISCORD_MESSAGE_EMBED_JOIN_MEMBERS
