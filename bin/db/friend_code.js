...
class FriendCodeRepository {
    ...
    insert_t_friend_code(data) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            logger_1.logger.info(`insert into t_friend_code. data = ${JSON.stringify(data)}`);
            const result = yield this.client.t_friend_code.create({ data: data });
    ...
    update_t_friend_code(data) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const exeute_date = new Date();
            data.update_time = exeute_date;
            logger_1.logger.info(`update t_friend_code. data = ${JSON.stringify(data)}, key = { server_id: ${data.server_id}, user_id = ${data.user_id}, game_id = ${data.game_id} }`);
            try {
                const result = yield this.client.t_friend_code.update({
                    where: {
    ...
    delete_t_friend_code(server_id, user_id, game_id) {
        return __awaiter(this, void 0, void 0, function* () {
            logger_1.logger.info(`delete t_friend_code. server_id = ${server_id}, user_id = ${user_id}, game_id = ${game_id}`);
            const result = yield this.client.t_friend_code.deleteMany({
                where: {
                    server_id: server_id,
                    user_id: user_id,
                    game_id: game_id
    ...
    delete_t_friend_code_all() {
        return __awaiter(this, void 0, void 0, function* () {
            logger_1.logger.info(`delete all t_friend_code.`);
            const result = yield this.client.t_friend_code.deleteMany({});
            logger_1.logger.info(`delete succeeded. count = ${result.count}`);
            return result.count;
        });
    ...
    get_t_friend_code_all(server_id) {
        return __awaiter(this, void 0, void 0, function* () {
            logger_1.logger.info(`select t_friend_code. server_id = ${server_id}`);
            let ret = [];
            const result = yield this.client.t_friend_code.findMany({
                where: {
                    server_id: server_id,
                    delete: false
                }
    ...
    get_t_friend_code(server_id, user_id) {
        return __awaiter(this, void 0, void 0, function* () {
            logger_1.logger.info(`select t_friend_code. server_id = ${server_id}, user_id = ${user_id}`);
            let ret = [];
            const result = yield this.client.t_friend_code.findMany({
                where: {
                    server_id: server_id,
    ...
    get_t_friend_code_from_game_id(server_id, game_id) {
        return __awaiter(this, void 0, void 0, function* () {
            logger_1.logger.info(`select t_friend_code. server_id = ${server_id}, game_id = ${game_id}`);
            let ret = [];
            const result = yield this.client.t_friend_code.findMany({
                where: {
                    server_id: server_id,
