...
class FriendCodeHistoryRepository {
    ...
    create_all_database(db) {
        return new Promise((resolve, reject) => {
            ...
            const execute_sql_list = [FriendCodeHistoryRepository.SQL_CREATE_T_FRIEND_CODE];
 ...
 */
FriendCodeHistoryRepository.SQL_CREATE_T_FRIEND_CODE = 'CREATE TABLE IF NOT EXISTS [t_friend_code_history] ( [server_id] TEXT NOT NULL, [user_id] TEXT NOT NULL, [user_name] TEXT NOT NULL, [game_id] TEXT NOT NULL, [game_name] TEXT NOT NULL, [friend_code] TEXT NOT NULL, [regist_time] DATETIME NOT NULL, [update_time] DATETIME NOT NULL, [delete] BOOLEAN NOT NULL )';
/**
 * insert SQL
 */
FriendCodeHistoryRepository.SQL_INSERT_T_FRIEND_CODE = 'INSERT INTO [t_friend_code_history] ([server_id], [user_id], [user_name], [game_id], [game_name], [friend_code], [regist_time], [update_time], [delete]) values ($server_id, $user_id, $user_name, $game_id, $game_name, $friend_code, $regist_time, $update_time, $delete) ';
/**
 * update SQL
 */
FriendCodeHistoryRepository.SQL_UPDATE_T_FRIEND_CODE = 'UPDATE [t_friend_code_history] SET [server_id] = $server_id, [user_id] = $user_id, [user_name] = $user_name, [game_id] = $game_id, [game_name] = $game_name, [friend_code] = $friend_code, [regist_time] = $regist_time, [update_time] = $update_time, [delete] = $delete ';
/**
 * select SQL
 */
FriendCodeHistoryRepository.SQL_SELECT_T_FRIEND_CODE = 'SELECT t1.[server_id], t1.[user_id], t1.[user_name], t1.[game_id], t1.[game_name], t1.[friend_code], t1.[regist_time], t1.[update_time], t1.[delete] FROM [t_friend_code_history] t1 ';
/**
 * delete SQL
 */
FriendCodeHistoryRepository.SQL_DELETE_T_FRIEND_CODE = 'DELETE FROM [t_friend_code_history] ';
