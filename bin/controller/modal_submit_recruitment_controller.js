...
class ModalSubmitRecruitmentController {
    ...
    regist(interaction) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const token = yield this.recruitment_repo.get_m_recruitment_token();
                ...
                // get number
                const recruitment_id = yield this.recruitment_repo.get_m_recruitment_id();
                ...
                // regist recruitment
                let affected_data_cnt = yield this.recruitment_repo.insert_m_recruitment(recruitment);
                logger_1.logger.info(`recruitment registration completed. affected_data_cnt = ${affected_data_cnt}`);
                // participate registration.
                affected_data_cnt = yield this.participate_repo.insert_t_participate(owner_participate);
                ...
                logger_1.logger.error(`create new recruitment error.`, err);
                yield interaction.reply(`${constants.DISCORD_MESSAGE_EXCEPTION} (Error : ${err})`);
                return false;
            }
            logger_1.logger.info(`create new recruitment completed.`);
            return true;
        });
    }
    /**
    ...
    edit(interaction) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                // get new token
                const new_token = yield this.recruitment_repo.get_m_recruitment_token();
                ...
                affected_data_cnt = yield this.recruitment_repo.insert_m_recruitment(recruitment);
                ...
                // participate registration.
                affected_data_cnt = yield this.participate_repo.insert_t_participate_list(recruitment.user_list);
                ...
                logger_1.logger.error(`edit recruitment error.`, err);
                yield interaction.reply(`${constants.DISCORD_MESSAGE_EXCEPTION} (Error : ${err})`);
                return false;
            }
            logger_1.logger.info(`edit recruitment completed.`);
            return true;
        });
    }
    /**
     ...
     * @param interaction
     */
    get_owner_participate(interaction) {
