...
class ModalSubmitFriendCodeController {
    ...
    regist(interaction) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const friend_code_list = yield this.fc_repo.get_t_friend_code(discord_common_1.DiscordCommon.get_guild_id_from_guild(interaction.guild), discord_common_1.DiscordCommon.get_user_id_from_user(interaction.user));
                // friend code object
                ...
                if (is_data_insert == true) {
                    ...
                    // execute insert
                    affected_data_cnt = yield this.fc_repo.insert_t_friend_code(friend_code);
                    ...
                    // execute update
                    affected_data_cnt = yield this.fc_repo.update_t_friend_code(friend_code);
                ...
                logger_1.logger.error(`regist friend code error.`, err);
                yield interaction.reply(`${constants.DISCORD_MESSAGE_EXCEPTION} (Error : ${err})`);
                return false;
            }
            logger_1.logger.info(`regist friend code completed.`);
            return true;
        });
    }
    /**
     ...
     * @returns
     */
    get_insert_data(interaction, target_game_id, input_friend_code) {
        // create instance
     ...
     * @returns
     */
    get_update_data(interaction, target_game_id, input_friend_code, friend_code) {
        // set value to object
        friend_code.game_name = discord_common_1.DiscordCommon.get_game_master_from_list(target_game_id, discord_common_1.DiscordCommon.get_game_master_from_guild(interaction.guild, constants.DISCORD_FRIEND_CODE_IGNORE_ROLE_LIST, constants.DISCORD_FRIEND_CODE_OTHER_COUNT)).game_name;
        friend_code.user_name = discord_common_1.DiscordCommon.get_user_name_from_user(interaction.user);
        friend_code.update_time = new Date();
