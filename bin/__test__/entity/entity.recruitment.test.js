...
describe("entity.recruitment test.", () => {
    ...
    ])("test for parse recruitment, id = %s", (id, server_id, message_id, thread_id, token, status, name, owner_id, description, deleted, limit_time, regist_time, update_time) => {
    ...
    ])("test for parse error recruitment, {%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s}", (id, server_id, message_id, thread_id, token, status, name, owner_id, description, deleted, limit_time, regist_time, update_time) => {
        expect(recruitment_1.Recruitment.parse_from_db({
            id: id,
            server_id: server_id,
            message_id: message_id,
