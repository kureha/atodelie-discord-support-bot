...
describe("entity.game_master test.", () => {
    ...
    ])("test for parse game master info, id = %s", (server_id, game_id, game_name, regist_time, update_time, deleted) => {
    ...
    ])("test for parse error game master info, {%s, %s, %s, %s, %s, %s}", (server_id, game_id, game_name, regist_time, update_time, deleted) => {
        expect(game_master_1.GameMaster.parse_from_db({
            server_id: server_id,
            game_id: game_id,
            game_name: game_name,
