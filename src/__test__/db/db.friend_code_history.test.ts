...
const sqlite_file: string = './.data/db.friend_code_history.test.sqlite';

describe("db.friend_code_history intialize test", () => {
    test("test for initialize", async () => {
        const rep = new FriendCodeHistoryRepository(":memory:");
...
describe("db.friend_code_history test.", () => {
    ...
    test("constructor test", () => {
        const rep = new FriendCodeHistoryRepository(sqlite_file);
