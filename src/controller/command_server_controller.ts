...
export class CommandServerController {
     ...
     * @param interaction 
     */
    async regist_server_master(interaction: Discord.ChatInputCommandInteraction, is_check_privillege: boolean = true): Promise<boolean> {
        try {
            ...
            const role_select_action_row: Discord.ActionRowBuilder<Discord.StringSelectMenuBuilder> = DiscordCommon.get_role_list_select_menu(
