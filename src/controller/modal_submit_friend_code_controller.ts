...
export class ModalSubmitFriendCodeController {
    ...
    static async regist(interaction: Discord.ModalSubmitInteraction): Promise<boolean> {
        return new Promise<boolean>(async (resolve, reject) => {
            try {
                ...
                const friend_code_list = await fc_repo.get_t_friend_code(
                ...
                if (is_data_insert == true) {
                    ...
                    // execute insert
                    affected_data_cnt = await fc_repo.insert_t_friend_code(friend_code);
                    ...
                    // execute update
                    affected_data_cnt = await fc_repo.update_t_friend_code(friend_code);
     ...
     * @returns 
     */
    static get_insert_data(interaction: Discord.ModalSubmitInteraction, target_game_id: string, input_friend_code: string): FriendCode {
        // create instance
     ...
     * @returns 
     */
    static get_update_data(interaction: Discord.ModalSubmitInteraction, target_game_id: string, input_friend_code: string, friend_code: FriendCode): FriendCode {
        // set value to object
        friend_code.game_name = DiscordCommon.get_game_master_from_list(
            target_game_id,
            DiscordCommon.get_game_master_from_guild(
