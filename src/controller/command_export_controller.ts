...
export class CommandExportController {
     ...
     * @param interaction
     */
    static async export_user_info(interaction: Discord.ChatInputCommandInteraction, is_check_privillege: boolean = true): Promise<boolean> {
        return new Promise<boolean>(async (resolve, reject) => {
            try {
                ...
                // reject
                reject(`export user info error. error = ${err}`);
            };
        });
    }
}